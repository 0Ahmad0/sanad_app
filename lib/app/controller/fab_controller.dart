...
import '../../admin/widgets/key_code_dialog_widget.dart';
import '../core/helper/seeder.dart';
            ...
            try {
             ...
             await seederAll();
              ...
              ConstantsWidgets.TOAST(null,
                  textToast: AppString.message_successfully_restore, state: true);
              ...
              ConstantsWidgets.closeDialog();
              ConstantsWidgets.TOAST(null,
                  textToast: AppString.errorTryAgainLater, state: false);
            }
          },
        );
      },
